...
They form a significant reduction of the document to facts (expressed as
relations between entities). They are structured and 

In this project, we explore the role of knowledge graphs in generate a new dataset of knowledge graphs: one for each
example in the GovReport dataset. 
